...
<body>
    ...
    <div class="container">
      ...
      <hr>
      <p>Utilizamos os comandos <code>include</code> e/ou
    <code>require</code>
    para importar arquivos com recursos externos de qualquer
    natureza, permitindo
    ...
    <h2>Exemplos de carregamento de conteúdo parcial/fragmento</h2>
    <section>
        <h3>Título </h3>
        <?php include "textos.php" ?>  //implementando arquivo de textos.php
