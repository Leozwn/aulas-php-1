...
<body>
    ...
    <div class="container">
        ...
        <?php
            $preco = 10567.86;
            $numeroComMuitasCasaDecimais = 1458.4567123;
        ?>
        <p>Preço formatado:
            <b>R$ <?= number_format($preco, 2, ",", ".") ?></b>
        </p>
        <p>Número com ajuste de cadas decimais:
            <?= number_format($numeroComMuitasCasaDecimais, 3) ?>
        </p>

        <h2>Data e Hora</h2>
        <h3>date(), date_defaul_timezone_set(), strtotime()</h3>
        <?php
