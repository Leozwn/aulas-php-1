...
<head>
    ...
    <title>Funções nativas para textos</title>
...
<body>
    <div class="container">
        ...
        /* Se usar "str_ireplace" ele difencia palavras em maiusculo e as troca também como "BOBO" ele a troca por "cara legal". */
        ...
        <h2>strip_tags()</h2>
        <?php
            $codigoHTML = "<h3>HTML 5 - <a href='https://sp.senac.br'>Senac</a> </h3>";
