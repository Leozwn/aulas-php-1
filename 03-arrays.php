...
<body>
    ...
    <?php
        ...
        $bandas = ["Savage", "Iron Maiden", "Slayer", "Nightwish"];
    ...
    <p>Nome do curso: <b><?= $cursos["titulo"] ?></b></p>
    <p>CH: <b><?= $cursos["carga_horaria"] ?> horas</b></p>
    <p>Descrição: <b><?= $cursos["descricao"] ?></b></p>
    <p>Prestador de serviços: <i><?= EMPRESA["nome"] ?></i></p>

    <h2>Arrasys de arrays (Matrizes)</h2>
    <?php
